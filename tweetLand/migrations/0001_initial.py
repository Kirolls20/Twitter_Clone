    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.ManyToManyField(related_name='tweet_comment', through='tweetLand.Comment', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='comment',
            name='tweet',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tweetLand.tweet'),
        ),
        migrations.AddField(
            model_name='comment',
            name='user',
